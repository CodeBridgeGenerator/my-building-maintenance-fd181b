...
const MaintenanceHistoryMaintenanceRequestPage = (props) => {
  return (
          ...
          >
            <div className="flex align-items-center text-white">
              <p className="text-4xl text-white">
                {props.selectedMaintenanceRequest?.name + " > "} Maintenance History
              </p>
            </div>
          </div>
...
export default connect(mapState, mapDispatch)(MaintenanceHistoryMaintenanceRequestPage);