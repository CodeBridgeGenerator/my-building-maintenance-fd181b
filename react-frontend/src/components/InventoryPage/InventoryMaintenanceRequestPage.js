...
const InventoryMaintenanceRequestPage = (props) => {
  return (
          ...
          >
            <div className="flex align-items-center text-white">
              <p className="text-4xl text-white">
                {props.selectedMaintenanceRequest?.name + " > "} Inventory
              </p>
            </div>
          </div>
          <InventoryPage />
...
export default connect(mapState, mapDispatch)(InventoryMaintenanceRequestPage);