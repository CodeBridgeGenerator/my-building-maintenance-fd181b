...
const BuildingLayout = (props) => {
    ...
    to: `/buildings/${urlParams.singleBuildingsId}/maintenanceRequests`,
  }, 
{
    label: "Maintenance History",
    icon: "pi pi-fw pi-cog",
    to: `/buildings/${urlParams.singleBuildingsId}/maintenanceHistory`,
  }
            ]
        }
    ];
...
const mapState = (state) => {
    ...
    return { selectedBuilding, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneBuilding: (id) => dispatch.building.getOneBuilding(id),
  });

export default connect(mapState, mapDispatch)(BuildingLayout);
