...
const MaintenanceHistoryBuildingPage = (props) => {
  return (
    <BuildingLayout>
      <div className="pt-2">
          ...
          >
            <div className="flex align-items-center text-white">
              <p className="text-4xl text-white">
                {props.selectedBuilding?.name + " > "} Maintenance History
              </p>
            </div>
          </div>
...
export default connect(mapState, mapDispatch)(MaintenanceHistoryBuildingPage);