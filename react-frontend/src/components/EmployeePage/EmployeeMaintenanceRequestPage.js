...
const EmployeeMaintenanceRequestPage = (props) => {
  return (
          ...
          >
            <div className="flex align-items-center text-white">
              <p className="text-4xl text-white">
                {props.selectedMaintenanceRequest?.name + " > "} Employee
              </p>
            </div>
          </div>
          <EmployeePage />
...
export default connect(mapState, mapDispatch)(EmployeeMaintenanceRequestPage);