...
const MaintenanceRequestLayout = (props) => {
    ...
    to: `/maintenanceRequests/${urlParams.singleMaintenanceRequestsId}/workOrders`,
  }, 
{
    label: "Maintenance History",
    icon: "pi pi-fw pi-cog",
    to: `/maintenanceRequests/${urlParams.singleMaintenanceRequestsId}/maintenanceHistory`,
  }
            ]
        }
    ];
...
const mapState = (state) => {
    ...
    return { selectedMaintenanceRequest, menuOpen };
  };
  const mapDispatch = (dispatch) => ({
    setMenuOpen: (bool) => dispatch.layout.setMenuOpen(bool),
    getOneMaintenanceRequest: (id) => dispatch.maintenanceRequest.getOneMaintenanceRequest(id),
  });

export default connect(mapState, mapDispatch)(MaintenanceRequestLayout);
