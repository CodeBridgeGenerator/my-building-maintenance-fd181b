...
const UserMaintenanceRequestPage = (props) => {
  return (
          ...
          >
            <div className="flex align-items-center text-white">
              <p className="text-4xl text-white">
                {props.selectedMaintenanceRequest?.name + " > "} Users
              </p>
            </div>
          </div>
          <UsersPage />
...
export default connect(mapState, mapDispatch)(UserMaintenanceRequestPage);